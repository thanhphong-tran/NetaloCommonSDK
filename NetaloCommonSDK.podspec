#
#  Be sure to run `pod spec lint NetaloCommonSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/NetaloCommonSDK"
  ...
  #spec.source_files  = "NetaloCommonSDK/**/*.{h,m,swift}"
  #spec.exclude_files = "NetaloCommonSDK/Exclude"
