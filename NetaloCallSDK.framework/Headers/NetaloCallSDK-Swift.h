...
#ifndef NETALOCALLSDK_SWIFT_H
#define NETALOCALLSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NetaloCallSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC13NetaloCallSDK12WebRTCClient")
...
@interface WebRTCClient (SWIFT_EXTENSION(NetaloCallSDK)) <RTCDataChannelDelegate>
...
@interface WebRTCClient (SWIFT_EXTENSION(NetaloCallSDK)) <RTCPeerConnectionDelegate>
